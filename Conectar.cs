...
namespace WinFormsApp1
{
    public partial class Conectar: Form
    {
        ...
        public Conectar()
        {
            ...
            this.MouseDown += new MouseEventHandler(Conectar_MouseDown);
            panel1.MouseDown += new MouseEventHandler(Conectar_MouseDown);
        }
        ...
        private void Conectar_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Introduca una contraseña");
            }
        }
    }
}
